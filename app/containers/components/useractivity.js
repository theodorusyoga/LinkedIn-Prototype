...
const UserActivity = ({ type, iconType, user }) => {
    if (type == 'user') {
        return (
            <div className="row">
                <div className="card-user-image col-3 col-sm-3 col-md-2 col-lg-2 pr-0">
                    <img className="rounded-circle" src={user.pic} width={50} height={50} alt={name} />
                </div>
                <div className="card-user-details col-9 col-sm-9 col-md-10 col-lg-10 pl-0">
        ...
        return (
            <div className="row">
                <div className="card-user-image col-3 col-sm-3 col-md-2 col-lg-2 pr-0 pt-1">
                    {selectIcon(iconType)}
                </div>
                <div className="card-user-details col-9 col-sm-9 col-md-10 col-lg-10 pl-0">
